...
def plot_figure9():
    ...
    plot_item10 = {
        ...
        'contour_line_levels': [1.1, 2.2]+list(np.linspace(0., 22., 21)[::4][1:]),
        'contour_line_label_fmt': '%.1f',
...
def plot_figure10():
    ...
    plot_item10 = {
        ...
        'contour_line_levels': [1.1]+list(linspace10[::4][1:]),
        'contour_line_label_fmt': '%.1f',
    ...
    plot_item11 = {
        ...
        'contour_line_levels': [2.3]+list(linspace11[::4][1:]),
        'contour_line_label_fmt': '%.1f',
    ...
    plot_item12 = {
        ...
        'contour_line_levels': [3.8]+list(linspace12[::4][1:]),
        'contour_line_label_fmt': '%.1f',
